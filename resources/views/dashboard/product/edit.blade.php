            ...
            <div class="card-body">
                ...
                <div class="pl-lg-4">
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <select class="form-control selectpicker"  id="category" @error('category') is-invalid @enderror" name="category" value="{{$product->category ?? old('category') }}" required autocomplete="category" autofocus>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <select class="form-control selectpicker" id="sexe" @error('sexe') is-invalid @enderror" name="sexe" value="{{$product->detail()->sexe ?? old('sexe') }}" required autocomplete="sexe" autofocus>
                ...
                <div class="pl-lg-4">
                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="number" id="quantity" name="quantity" value="{{$product->available ?? old('quantity') }}" class="form-control" required placeholder="Quantity">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="dropzone">
                        ...
                        <input type="file" name="image1" id="image1"  class="upload-input btn" />
                      </div>
                      @error('image1')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" id="brand" name="brand" value="{{$product->brand ?? old('brand') }}" class="form-control" required placeholder="Brand">
                        @error('brand')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <select class="form-control selectpicker" multiple type="text" id="size" name="size[]" value="{{$product->detail()->size ?? old('size') }}"   placeholder="Size">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <select class="form-control selectpicker" multiple type="text" id="color" name="color[]" value="{{$product->detail()->color ?? old('color') }}"   placeholder="Color">
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <select class="form-control selectpicker" type="text" id="showen_as" name="showen_as" value="{{$product->showen_as ?? old('showen_as') }}"   placeholder="Showen As">
                      <option value="new" selected>New</option>
                      <option value="sale">Sale</option>
                      <option value="normal">Normal</option>
                      <option value="hiden">Hiden</option>
                    </select>
                    <script>$("#showen_as").val('{{$product->showen_as}}')</script>
                    @error('showen_as')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="text" id="sale" name="sale" value="{{$product->sale ?? old('sale') }}" class="form-control" required placeholder="Sale Value %">
                    @error('sale')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="pl-lg-4">
                  ...
                  <textarea rows="4" class="form-control" name="description"  placeholder="A few words about the product ...">{{$product->description ?? old('description') }}</textarea>
                  </div>
                </div>
                <hr class="my-4" />
